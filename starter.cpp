...
void BaseProject::initWindow() {
    ...
    fmwk::GameEngine::getInstance()->setWindow(window);
}
...
void BaseProject::framebufferResizeCallback(GLFWwindow* window, int width, int height) {
    ...
    fmwk::GameEngine::getInstance()->windowResizeCallback(window, width, height);
}
...
void BaseProject::initVulkan() {
    ...
    fmwk::GameEngine::getInstance()->bootInputSystem();
...
void BaseProject::createRenderPass() {
...
void BaseProject::createFramebuffers() {
...
void BaseProject::createColorResources() {
...
void BaseProject::createDepthResources() {
