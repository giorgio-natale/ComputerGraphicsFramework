...
void ModelTransformationAndMaterialDemo::setWindowParameters() {
...
void ModelTransformationAndMaterialDemo::onWindowResize(int w, int h) {
    Ar = (float)w / (float)h;
}

// Here you load and setup all your Vulkan Models and Textures.
// Here you also create your Descriptor set layouts and load the shaders for the pipelines
void ModelTransformationAndMaterialDemo::localInit() {
    ...
    gameEngine->addEntity(std::move(pumpkinEntity));
    gameEngine->addEntity(std::move(ghostEntity));
...
void ModelTransformationAndMaterialDemo::pipelinesAndDescriptorSetsInit() {
    auto gameEngine = fmwk::GameEngine::getInstance();
...
void ModelTransformationAndMaterialDemo::pipelinesAndDescriptorSetsCleanup() {
...
void ModelTransformationAndMaterialDemo::localCleanup() {
...
void ModelTransformationAndMaterialDemo::populateCommandBuffer(VkCommandBuffer commandBuffer, int currentImage) {
    auto gameEngine = fmwk::GameEngine::getInstance();
...
void ModelTransformationAndMaterialDemo::updateUniformBuffer(uint32_t currentImage) {
    auto gameEngine = fmwk::GameEngine::getInstance();
