...
void ColliderTest::setWindowParameters() {
...
void ColliderTest::onWindowResize(int w, int h) {
    Ar = (float) w / (float) h;
}

// Here you load and setup all your Vulkan Models and Textures.
// Here you also create your Descriptor set layouts and load the shaders for the pipelines
void ColliderTest::localInit() {
    ...
    cubeEntity->addComponent(std::make_unique<fmwk::Collider>(1.0f, "CHARACTER", glm::vec3(0,0,0)));
    cubeEntity->addComponent(
    ...
    auto sphereEntity1 = std::make_unique<fmwk::Entity>("spawnedSphere1", glm::vec3(3.0f, 0.0f, -3.0f),
                                                        glm::quat(1, 0, 0, 0));
    sphereEntity1->addComponent(std::make_unique<fmwk::Collider>(0.8f, "ENEMY", glm::vec3(0,0,0)));
    ...
    auto sphereEntity2 = std::make_unique<fmwk::Entity>("spawnedSphere2", glm::vec3(5.0f, 0.0f, 1.0f),
                                                        glm::quat(1, 0, 0, 0));
    sphereEntity2->addComponent(std::make_unique<fmwk::Collider>(0.8f, "ENEMY", glm::vec3(0,0,0)));
...
void ColliderTest::pipelinesAndDescriptorSetsInit() {
    auto gameEngine = fmwk::GameEngine::getInstance();
...
void ColliderTest::pipelinesAndDescriptorSetsCleanup() {
...
void ColliderTest::localCleanup() {
...
void ColliderTest::populateCommandBuffer(VkCommandBuffer commandBuffer, int currentImage) {
    auto gameEngine = fmwk::GameEngine::getInstance();
...
void ColliderTest::updateUniformBuffer(uint32_t currentImage) {
    auto gameEngine = fmwk::GameEngine::getInstance();
