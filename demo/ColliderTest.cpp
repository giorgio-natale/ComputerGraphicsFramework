...
void ColliderTest::localInit() {
    ...
    cubeEntity->addComponent(std::make_unique<fmwk::Collider>("CharacterCollider", 1.0f));
    cubeEntity->addComponent(
    ...
    auto sphereEntity1 = std::make_unique<fmwk::Entity>("spawnedSphere1", glm::vec3(3.0f, 0.0f, -3.0f),
                                                        glm::quat(1, 0, 0, 0));
    sphereEntity1->addComponent(std::make_unique<fmwk::Collider>("Sphere1Collider", 0.8f));
    ...
    auto sphereEntity2 = std::make_unique<fmwk::Entity>("spawnedSphere2", glm::vec3(5.0f, 0.0f, 1.0f),
                                                        glm::quat(1, 0, 0, 0));
    sphereEntity2->addComponent(std::make_unique<fmwk::Collider>("Sphere2Collider", 0.8f));
