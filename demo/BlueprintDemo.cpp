...
void BlueprintDemo::setWindowParameters() {
...
void BlueprintDemo::onWindowResize(int w, int h) {
    Ar = (float)w / (float)h;
}

// Here you load and setup all your Vulkan Models and Textures.
// Here you also create your Descriptor set layouts and load the shaders for the pipelines
void BlueprintDemo::localInit() {
...
void BlueprintDemo::pipelinesAndDescriptorSetsInit() {
    auto gameEngine = fmwk::GameEngine::getInstance();
...
void BlueprintDemo::pipelinesAndDescriptorSetsCleanup() {
...
void BlueprintDemo::localCleanup() {
...
void BlueprintDemo::populateCommandBuffer(VkCommandBuffer commandBuffer, int currentImage) {
    auto gameEngine = fmwk::GameEngine::getInstance();
...
void BlueprintDemo::updateUniformBuffer(uint32_t currentImage) {
    auto gameEngine = fmwk::GameEngine::getInstance();
